            ...
            <div class="right-section">
                ...
                <div class="input-group">
                    ...
                    <div style="display: flex; gap: 5px; align-items: center;">
                        ...
                        <input type="button" value="우편번호검색" onclick="openPostcode()" style="padding: 12px 14px; border-radius: 8px; cursor: pointer;">
                    </div>
                    <input type="text" id="address1" name="address1" placeholder="주소" style="margin-top: 5px;" readonly>
