			...
			<div class="slide-container">
				...
				<div class="slide-item">
					<div class="hot-study-card" data-hot-study-id="1"
						...
						<p class="hot-study-description">Hooks, Redux를 활용한 실전 프로젝트 중심.</p>
					...
					<div class="hot-study-card" data-hot-study-id="2"
						...
						<p class="hot-study-description">REST API 설계 및 구현을 위한 백엔드 스터디.</p>
						<div class="hot-study-info">
							<p>
				...
				<div class="slide-item">
					...
					<div class="hot-study-card" data-hot-study-id="5"
						...
						<div class="hot-study-progress">✅ 자리 여유 있음!</div>
					</div>
