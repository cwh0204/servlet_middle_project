...
<script type="text/javascript">
	function generateStudyCard(team) {
		...
		const cardHtml = '<article class="study-card glass-card">'
				+ '<div class="card-gradient"></div>'
				+ '<div class="badge-corner badge-gold"></div>'
				+ '<div class="card-header">' + '<div class="study-name">' +
		...
		'<span>상세보기</span>' + '</button>' + '<button class="btn-leave">'
				+ '<span>탈퇴</span>' + '</button>' + '</div>' + '</article>';
