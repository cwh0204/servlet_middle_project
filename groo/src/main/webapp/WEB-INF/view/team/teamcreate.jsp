...
<main>
		...
		<div class="form-box">
			<div class="category_container">
				<div class="studyTitle_box">
					<label>스터디명 </label><br> <input type="text" name="teamName"
						class="teamName" placeholder="스터디명을 입력해주세요.">
				</div>
  ...
  <div class="category-box">
    ...
    <div class="subcategory-group">
      ...
      <input type="radio" id="psychology" name="studyField" value="심리"><label for="language">심리</label>
      <input type="radio" id="language" name="studyField" value="외국어"><label for="management">외국어</label>
      <input type="radio" id="management" name="studyField" value="재테크"><label for="psychology">재테크</label>
    </div>
  </div>
  ...
  <div class="category-box">
    ...
    <div class="subcategory-group">
      ...
      <input type="radio" id="music" name="studyField" value="음악"><label for="art">음악</label>
    </div>
  </div>
    ...
    <div class="subcategory-group">
      ...
      <input type="radio" id="rehab" name="studyField" value="재활"><label for="rehab">재활</label>
				...
				<div class="memberage_box">
					...
					<div class="range-container">
						<input type="range" id="teamMemberage" name="teamMemberage"
							min="14" max="70" step="1" value="25"> <span
				...
				<div class="studycontent_box">
					<label>스터디 소개</label> <input type="text" name="teamInfo"
						class="teamInfo" placeholder="">
				</div>

				<div class="studyintroduce_box">
					<label>스터디 내용</label> <input type="text" name="teamcontent"
						class="teamcontent" placeholder="">
				</div>


				<button type="submit" class="btn btn-primary submit-btn">팀
					생성하기</button>
