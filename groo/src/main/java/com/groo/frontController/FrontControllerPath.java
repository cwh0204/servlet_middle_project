...
import com.groo.controller.AdminDeleteCommentController;
...
import com.groo.controller.AdminSelectCommentController;
import com.groo.controller.AdminSelectDisableStudyMemberController;
import com.groo.controller.AdminSelectRankController;
import com.groo.controller.AdminSelectSearchUserController;
import com.groo.controller.AdminSelectStatsCategoryController;
import com.groo.controller.AdminSelectStatsDayController;
import com.groo.controller.AdminSelectStatsPostDayController;
import com.groo.controller.AdminSelectStatsSignUpMonthController;
...
import com.groo.controller.AdminUpdateStudyRankCotroller;
...
import com.groo.controller.MemberSelectBeenCheckController;
...
public class FrontControllerPath {
    ...
    public FrontControllerPath() {
        ...
        controllerMap.put("/adminselectcomment.do", new AdminSelectCommentController());
        controllerMap.put("/admindeletecomment.do", new AdminDeleteCommentController());
        controllerMap.put("/adminselectrank.do", new AdminSelectRankController());
        controllerMap.put("/adminupdatestudyrank.do", new AdminUpdateStudyRankCotroller());
        controllerMap.put("/adminselectstatsday.do", new AdminSelectStatsDayController());
        controllerMap.put("/adminselectstatspostday.do", new AdminSelectStatsPostDayController());
        controllerMap.put("/adminselectstatscategory.do", new AdminSelectStatsCategoryController());
        controllerMap.put("/adminselectstatssignupmonth.do", new AdminSelectStatsSignUpMonthController());
